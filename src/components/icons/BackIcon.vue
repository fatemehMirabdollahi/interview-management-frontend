<template>
  ...
  >
    <polygon
      :style="`fill : ${theme == 'light' ? '#394454' : '#eae9f4'}`"
      points="233.739,68.885 13.83,213.874 233.739,358.862 "
    />
    <g>
      <path
        :style="`fill : ${theme == 'light' ? '#eae9f4' : '#394454'}`"
        d="M319.08,139.484h-71.511V68.885c0-5.088-2.794-9.765-7.273-12.177
      ...
      <path
        :style="`fill : ${theme == 'light' ? '#eae9f4' : '#394454'}`"
        d="M498.171,456.945c-4.705,0-9.198-2.409-11.765-6.561l-57.03-92.286
